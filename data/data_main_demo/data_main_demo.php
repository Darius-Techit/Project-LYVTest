...
if ($Action == 'showCenter'){
    ...
    $sqlDA = '';
    if ($ArtNo !=''){
        $sqlDA .="AND et.ArticleNo = '$ArtNo' ";
    }
    if ($Cat !=''){
        $sqlDA .="AND et.Category = '$Cat' ";
    }
    $qry_SearhTest = "SELECT et.ArticleNo ArtNo, et.ArticleName ArtName, et.Category Cat, et.Stage
                            ,et.Issuse_Comment IssuseComment,et.Picture Pic, et.Res_Dept ResDept, et.UserID, et.UserDate
                      FROM EIP_Test AS et
                      WHERE 1=1 ". $sqlDA." ";

            //   $abc= " SELECT et.ArticleNo ArtNo, et.ArticleName ArtName, et.Category Cat, et.Stage ,et.Issuse_Comment IssuseComment,et.Picture Pic, et.Res_Dept ResDept, et.UserID, et.UserDate 
            //         FROM EIP_Test AS et 
            //         WHERE 1=1 " .$sqlDA ;
    // echo $abc;
